...
//
//  This is a slight modification of NSXMLReader

#import "BS3Parser.h"

NSString *const kXMLReaderTextNodeKey = @"text";

@interface BS3Parser (Internal)
...
@interface BS3Parser (/* Private */) < NSXMLParserDelegate>

@end

@implementation BS3Parser {
...
+ (NSDictionary *)dictionaryForPath:(NSString *)path error:(NSError **)errorPointer {
    ...
    NSDictionary *rootDictionary = [BS3Parser dictionaryForXMLData:data error:errorPointer];
    
	return rootDictionary;
}

+ (NSDictionary *)dictionaryForXMLData:(NSData *)data error:(NSError **)error {
    BS3Parser *reader = [[BS3Parser alloc] initWithError:error];
...
+ (NSDictionary *)dictionaryForXMLString:(NSString *)string error:(NSError **)error {
    ...
    return [BS3Parser dictionaryForXMLData:data error:error];
}
...
#pragma mark - BS3DataParser methods
